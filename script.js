document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      doc.text("BYOMA", 20, y); y += lineHeight;
      doc.text("Website: byoma.com", 20, y); y += lineHeight;
      doc.text("Instagram: @byoma", 20, y); y += lineHeight * 2;
  ...
  function afterDownloadSuccess(data) {
    try {
      ...
      if (emailLink) {
        ...
        emailLink.href = `mailto:byomaskincarecollaboration@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
      }
    } catch (err) {
